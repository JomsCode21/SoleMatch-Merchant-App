...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  await db.insert(activityLogs).values({
    ...
    description: `Product "${product.title}" was added. Inventory: ${inventory}. Priority: ${status}.`,
  });

  console.log(
    `Synced product ${product.title}: inventory=${inventory}, score=${priorityScore}, status=${status}`,
  );
